...
public class CommonConstants {
    ...
    // 收藏
    public static final String QUEUE_NAME_COLLECT = "queue.collect";
    public static final String QUEUE_KEY_COLLECT  = "collect";

    // 评论
    public static final String QUEUE_NAME_COMMENT = "queue.comment";
    public static final String QUEUE_KEY_COMMENT  = "comment";

    // 回复
    public static final String QUEUE_NAME_REPLY   = "queue.reply";
    public static final String QUEUE_KEY_REPLY    = "reply";

    // 关注
    public static final String QUEUE_NAME_FOLLOW  = "queue.follow";
    public static final String QUEUE_KEY_FOLLOW   = "follow";

    // 支付
    public static final String QUEUE_NAME_PAY     = "queue.pay";
    public static final String QUEUE_KEY_PAY      = "pay";

    // 注册
    public static final String QUEUE_NAME_REGISTER = "queue.register";
    public static final String QUEUE_KEY_REGISTER  = "register";

    // 取消点赞
    public static final String QUEUE_NAME_CANCEL_PRAISE = "queue.cancelPraise";
    public static final String QUEUE_KEY_CANCEL_PRAISE  = "cancelPraise";

    // 取消收藏
    public static final String QUEUE_NAME_CANCEL_COLLECT = "queue.cancelCollect";
    public static final String QUEUE_KEY_CANCEL_COLLECT  = "cancelCollect";

    // 取消关注
    public static final String QUEUE_NAME_CANCEL_FOLLOW = "queue.cancelFollow";
    public static final String QUEUE_KEY_CANCEL_FOLLOW  = "cancelFollow";
